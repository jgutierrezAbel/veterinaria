...
<html lang="en">
  ...
  <div class="container-fluid">
    <a href="/portada" class="navbar-brand">Inicio</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <li class="nav-item">
          <a href="/portada/create" class="nav-link" href="#">Acerca de nosotros</a>
        </li>
        </li>

        <li class="nav-item">
          <a href="/" class="nav-link active" aria-current="page" href="#">Cerrar Sesión</a>
        </li>
